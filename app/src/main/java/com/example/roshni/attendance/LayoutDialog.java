...
public class LayoutDialog extends AppCompatDialogFragment
{
    ...
    {
        context=c;
        mod_id=id;  mod_sub_name=sub_name;  mod_min_percent=min_percent;
        mod_present=present;    mod_absent=absent;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState)
    {
        ...
        subname=(EditText) view.findViewById(R.id.modify_subj_name);
        minpercent=(EditText) view.findViewById(R.id.modify_min_percent);
        present=(EditText) view.findViewById(R.id.modify_presents);
        absent=(EditText) view.findViewById(R.id.modify_absents);
